    ...
    <div className="min-h-screen bg-[#0B0F19] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="glass-panel p-8 md:p-10 rounded-3xl backdrop-blur-2xl bg-[#0B0F19]/80 border border-white/10 shadow-[0_0_50px_rgba(0,255,178,0.05)]">
          ...
          {/* Social Sign-In OR Already Signed-In Options */}
          <div className="space-y-4">
            {isSignedIn ? (
              <>
                <div className="bg-[#00FFB2]/10 border border-[#00FFB2]/30 text-[#00FFB2] rounded-xl p-4 text-xs font-semibold text-center mb-2 backdrop-blur-md">
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="w-full py-4 rounded-xl bg-white/5 border border-white/10 text-white font-bold uppercase tracking-widest hover:bg-white/10 transition-all flex items-center justify-center gap-2 group text-sm cursor-pointer disabled:opacity-50"
                >
